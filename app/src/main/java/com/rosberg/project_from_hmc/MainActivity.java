package com.rosberg.project_from_hmc;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        resultstatu = findViewById(R.id.textView2);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == VOICE_RECOGNITION_REQUEST_CODE && resultCode == RESULT_OK) {
            ...
            String url = "http://160.39.239.137/";
            String result_get = requestpost(url,textweget);
            StringBuilder resultrepo = new StringBuilder();
            resultrepo.append(result_get);
            resultstatu.setText(resultrepo);
